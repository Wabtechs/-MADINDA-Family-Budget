      ...
      <section className="py-5 position-relative overflow-hidden">
        ...
        <div className="container py-5 position-relative">
          <div className="text-center mb-5">
            <span className="d-inline-block bg-primary/10 text-primary rounded-pill px-3 py-1 mb-3 fs-6 fw-semibold">Fonctionnement</span>
                ...
                {i % 2 === 0 ? (
                  <>
                      ...
                      <ul className="list-unstyled small d-flex flex-column gap-2">
                        {s.details.map((d, j) => (
                          <li key={j} className="d-flex align-items-center gap-2">
                            <span className="bg-primary/10 text-primary rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style={{ width: 24, height: 24, fontSize: '0.75rem' }}>✓</span>
                            {d}
                          </li>
                        ))}
                      </ul>
                    ...
                    <div className="col-lg-2 d-none d-lg-flex justify-content-center">
                      <div className="bg-primary/10 rounded-circle" style={{ width: 4, height: 80 }} />
                    </div>
                      ...
                      <div className="bg-light rounded-3 p-4 border w-100" style={{ maxWidth: 320 }}>
                        <div className="bg-white rounded-2 p-3 shadow-sm">
                          <div className="d-flex align-items-center gap-2 mb-3">
                            <div className="bg-primary/10 rounded-2 px-2 py-1" style={{ width: 24, height: 24 }} />
                            <div className="bg-secondary/10 rounded-2" style={{ width: 100, height: 10 }} />
                          </div>
                          <div className="bg-secondary/10 rounded-2 mb-2" style={{ width: '100%', height: 60 }} />
                          <div className="d-flex gap-2">
                            <div className="bg-secondary/10 rounded-2 flex-grow-1" style={{ height: 30 }} />
                            <div className="bg-primary/20 rounded-2" style={{ width: 60, height: 30 }} />
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container py-5">
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <span className="d-inline-block bg-primary/10 text-primary rounded-pill px-3 py-1 mb-3 fs-6 fw-semibold">Aperçu</span>
            ...
            <div className="col-lg-6">
              <div className="bg-white rounded-4 shadow-lg p-4 border">
                <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                  <div className="bg-primary/10 rounded-2 d-flex align-items-center justify-content-center" style={{ width: 40, height: 40 }}>
                    <span className="text-primary fw-bold">M</span>
                  </div>
                  <div className="flex-grow-1">
                    <div className="bg-secondary/10 rounded-2 mb-1" style={{ width: 150, height: 12 }} />
                    <div className="bg-secondary/10 rounded-2" style={{ width: 100, height: 8 }} />
                  </div>
                  <div className="bg-success/10 rounded-2 px-3 py-1">
                ...
                <div className="d-flex gap-2 mb-4" style={{ height: 120 }}>
                  {[40, 65, 50, 80, 55, 45, 75, 60, 85, 50, 70, 55].map((h, i) => (
                    <div key={i} className="flex-grow-1 bg-primary/20 rounded-1" style={{ height: `${h}%`, alignSelf: 'flex-end' }} />
                  ))}
                </div>
