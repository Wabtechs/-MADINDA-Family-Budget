...
export default function HomePage() {
  ...
  return (
    <>
      <section className="position-relative overflow-hidden hero-gradient text-white">
        ...
        <div className="container position-relative py-5">
          <div className="row align-items-center py-5">
            ...
            <div className="col-lg-6 d-none d-lg-flex justify-content-center pb-5">
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-4 p-4 border border-white border-opacity-20 shadow-lg" style={{ maxWidth: 480, width: '100%', transform: 'perspective(1000px) rotateY(-5deg)' }}>
                <div className="d-flex align-items-center gap-3 mb-4">
                  ...
                  <div className="ms-auto">
                    <span className="badge bg-success bg-opacity-25 text-success px-2 py-1">En ligne</span>
                  </div>
                </div>
      ...
      <section className="py-5 stats-gradient text-white">
        <div className="container py-4">
          <div className="row g-4 text-center">
            {stats.map((s, i) => (
              <div key={i} className="col-6 col-lg-3">
                <div className="fw-bold" style={{ fontSize: '2.5rem' }}>{s.value}</div>
                <div className="text-white text-opacity-75 small text-uppercase" style={{ letterSpacing: '0.05em' }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
              ...
              <div key={i} className="col-md-4">
                <div className="card border-0 h-100 p-4" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.06)' }}>
                  <div className="d-flex align-items-center gap-3 mb-3">
                    <div className={`${t.color} text-white rounded-circle d-flex align-items-center justify-content-center fw-bold`} style={{ width: 50, height: 50, fontSize: '1.1rem' }}>
                      {t.name.charAt(0)}
                    </div>
                    <div>
